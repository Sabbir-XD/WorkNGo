...
const HowItWorks = () => {
  const steps = [
    {
      icon: (
        <FaPenAlt className="text-3xl text-green-600 dark:text-green-400" />
      ),
  ...
  return (
    <section
      id="works"
      className="py-12 md:py-16 bg-gradient-to-b from-green-50 to-white dark:from-gray-900 dark:to-gray-900"
    >
        ...
        >
          {steps.map((step, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-semibold text-green-800 dark:text-green-100 mb-2 sm:mb-3">
                {step.title}
              </h3>
