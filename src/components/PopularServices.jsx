        ...
        >
          {services.map((service, index) => (
            <SwiperSlide key={index}>
              <div
                className={`group p-6 rounded-xl transition-all duration-300 border ${service.color} shadow-sm hover:shadow-md cursor-pointer h-full flex flex-col items-center`}
              >
                <div
                  className={`w-14 h-14 mb-4 rounded-full bg-white flex items-center justify-center ${
